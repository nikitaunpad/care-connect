...
export default function ConsultationChatPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#F7F3ED] text-[#193C1F] font-sans">
      ...
      <header className="h-16 bg-white border-b border-[#D0D5CB] flex items-center justify-between px-6 z-10 shrink-0">
        <div className="flex items-center space-x-8">
          <Link href="/dashboard" className="flex items-center space-x-2 group">
            <div className="w-8 h-8 bg-[#8EA087] rounded-lg flex items-center justify-center group-hover:bg-[#193C1F] transition-colors">
              <svg
            ...
            <span className="text-xl font-bold tracking-tight text-[#193C1F]">
              CareConnect
            </span>
          </Link>
          <nav className="hidden md:flex space-x-6">
            <Link
              ...
              className="text-sm font-medium text-[#193C1F] hover:opacity-100 transition-opacity"
            >
              Consultations
            </Link>
            <Link
              href="#"
              className="text-sm font-medium text-[#193C1F] opacity-70 hover:opacity-100 transition-opacity"
            >
              Resources
            </Link>
            <Link
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <input
              className="bg-[#F7F3ED] border border-[#D0D5CB] rounded-lg pl-10 pr-4 py-1.5 text-sm w-64 focus:ring-[#8EA087] focus:border-[#8EA087] outline-none"
              placeholder="Search sessions..."
              type="text"
            />
            <svg
              className="w-4 h-4 absolute left-3 top-2.5 text-[#193C1F] opacity-40"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <button className="p-2 text-[#193C1F] opacity-60 hover:opacity-100 transition-opacity">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <Link
            href="/profile"
            className="w-10 h-10 rounded-full border-2 border-[#D1B698] overflow-hidden hover:brightness-95 transition"
          >
            <Image
              alt="User Profile"
              ...
              src={
                session?.user?.image ||
                'https://lh3.googleusercontent.com/aida-public/AB6AXuDt5mLJ07TsmYfRp_PRQa1zKpG5bCSf1iusrlGM5fVyictrFKj9HYGHZnsMkLfdM17YLRMx7ZwFDwptSR8uew2AOwpdcCCcyUxQdWjkXgpsxckloe8DmSBnOLHSvT-xabX0vbVMjaLVoMcGvRIkIXGNYnKWhi2GPwGSvjmdjLpFgTN2TXchEywSau23R0blUguvhfWxQ5ll8QsApddAEADQB9LjbJvUcw1LAS1O7caIOc_DNvuvgU2u73wU8e7kollncMJV-dE0dw'
              }
              unoptimized
            />
          </Link>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 flex flex-col bg-white min-w-0">
          <header className="h-16 border-b border-[#D0D5CB] flex items-center justify-between px-6 shrink-0 bg-white shadow-sm">
            <div className="flex items-center space-x-3">
              <Image
                ...
                height={40}
                className="w-10 h-10 rounded-full object-cover"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuA9k4zG4rxHN69gY41chf6wZxx4rxkOJbKoKoXBJRAe-lL634FV770V6ffA5A6Qmakn-31VXLLJJ3lT9BGZk39qoCwaKdui8NhJw9i9zHaKFfGbvrtkM4c5CTI7KHLvcgQNg_EL6-ivdOCbwG-N1c55OnhiMZFytYhXGNhILJA37PTIx51c5ot44BCbHhhUhbZ698lfAUAax91cia74S79iTQnwAg9vkxmeakE2Y1sb_1AHkQ1uot4DX4EpN12dccbkIPcHVWVvcQ"
                unoptimized
              />
              <div>
                <h3 className="text-sm font-bold text-[#193C1F]">
                  Dr. Sarah Miller
                </h3>
                <div className="flex items-center space-x-2">
                  <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                  <span className="text-[10px] uppercase font-bold text-[#193C1F] opacity-60 tracking-wider">
                    Online • Video Call Available
                  </span>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4 text-[#193C1F] opacity-70">
              <button className="p-2 hover:bg-[#F7F3ED] rounded-full transition-colors">
                <svg
                  className="w-5 h-5"
                  fill="none"
                  stroke="currentColor"
