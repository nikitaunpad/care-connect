    ...
    <div className="font-sans antialiased bg-[#F7F3ED] text-[#193C1F] min-h-screen">
      ...
      <header className="w-full bg-[#F7F3ED] py-6 px-12 flex justify-between items-center border-b border-[#D0D5CB]">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-[#193C1F] rounded-lg flex items-center justify-center text-[#F7F3ED]">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.744c0 5.578 4.5 10.13 10.125 10.13 5.625 0 10.125-4.552 10.125-10.13 0-1.494-.273-2.925-.77-4.244a11.959 11.959 0 0 1-8.355-3.212Z" strokeLinecap="round" strokeLinejoin="round"></path>
            </svg>
          </div>
        ...
        <nav className="flex items-center gap-12 text-[#193C1F] font-medium">
          <Link href="/landingPage" className="hover:text-[#8EA087] transition-colors">Home</Link>
          <Link href="/consultation" className="hover:text-[#8EA087] transition-colors">Consultation</Link>
          <Link href="#" className="hover:text-[#8EA087] transition-colors">Reports</Link>
          <Link href="#" className="hover:text-[#8EA087] transition-colors">Forum</Link>
          <Link href="/donation" className="hover:text-[#8EA087] transition-colors">Donation</Link>
        </nav>
        <Link href="/login">
        ...
        <div className="w-[600px] h-[400px] bg-[#D0D5CB] rounded-3xl flex items-center justify-center text-[#8EA087]">
          <div className="w-32 h-32">
            <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M10.5 19.5h3m-6.75-4.5h10.5" strokeLinecap="round" strokeLinejoin="round"></path>
            </svg>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#EDE4D8] py-20 px-12">
        <div className="max-w-[1440px] mx-auto grid grid-cols-3 gap-8">
          <div className="bg-[#F7F3ED] p-12 rounded-2xl text-center shadow-sm border-b-4 border-[#8EA087]">
            <p className="text-[#193C1F] font-semibold mb-2 opacity-80">Total Reports Handled</p>
            <h2 className="text-6xl font-black text-[#193C1F] mb-4">1,240</h2>
            <div className="w-16 h-1 bg-[#8EA087] mx-auto rounded-full"></div>
          </div>
          <div className="bg-[#F7F3ED] p-12 rounded-2xl text-center shadow-sm border-b-4 border-[#8EA087]">
            <p className="text-[#193C1F] font-semibold mb-2 opacity-80">Professional Consultations</p>
            <h2 className="text-6xl font-black text-[#193C1F] mb-4">3,500+</h2>
            <div className="w-16 h-1 bg-[#D1B698] mx-auto rounded-full"></div>
          </div>
          <div className="bg-[#F7F3ED] p-12 rounded-2xl text-center shadow-sm border-b-4 border-[#8EA087]">
            <p className="text-[#193C1F] font-semibold mb-2 opacity-80">Community Donations</p>
      ...
      <section className="max-w-[1440px] mx-auto py-32 px-12 text-center">
        <h2 className="text-5xl font-black text-[#193C1F] mb-6">How we support you</h2>
          ...
          <div className="bg-[#F7F3ED] p-8 rounded-2xl border border-[#D0D5CB] text-left shadow-sm flex flex-col items-start gap-4">
            <div className="w-12 h-12 bg-[#EDE4D8] rounded-lg flex items-center justify-center text-[#8EA087]">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.182 15.182a4.5 4.5 0 0 1-6.364 0M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Z" strokeLinecap="round" strokeLinejoin="round"></path>
              </svg>
            </div>
            <h3 className="text-2xl font-bold text-[#193C1F]">Consultation</h3>
            <p className="text-[#193C1F] opacity-80">One-on-one sessions with certified mental health professionals.</p>
          </div>
          <div className="bg-[#F7F3ED] p-8 rounded-2xl border border-[#D0D5CB] text-left shadow-sm flex flex-col items-start gap-4">
            <div className="w-12 h-12 bg-[#EDE4D8] rounded-lg flex items-center justify-center text-[#8EA087]">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 9v3.75m0-10.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.75c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.57-.598-3.75h-.152c-3.196 0-6.1-1.249-8.25-3.286Zm0 13.036h.008v.008H12v-.008Z" strokeLinecap="round" strokeLinejoin="round"></path>
              </svg>
            </div>
            <h3 className="text-2xl font-bold text-[#193C1F]">Reporting</h3>
            <p className="text-[#193C1F] opacity-80">Secure and anonymous incident reporting for community safety.</p>
          </div>
          <div className="bg-[#F7F3ED] p-8 rounded-2xl border border-[#D0D5CB] text-left shadow-sm flex flex-col items-start gap-4">
            <div className="w-12 h-12 bg-[#EDE4D8] rounded-lg flex items-center justify-center text-[#8EA087]">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-[#193C1F] opacity-80">Peer-led discussions and shared experiences in a moderated space.</p>
          </div>
          <div className="bg-[#F7F3ED] p-8 rounded-2xl border border-[#D0D5CB] text-left shadow-sm flex flex-col items-start gap-4">
            <div className="w-12 h-12 bg-[#EDE4D8] rounded-lg flex items-center justify-center text-[#8EA087]">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M21 11.25v8.25a1.5 1.5 0 0 1-1.5 1.5H4.5a1.5 1.5 0 0 1-1.5-1.5v-8.25m18 0-9-6.75-9 6.75m18 0V4.5a1.5 1.5 0 0 0-1.5-1.5H4.5A1.5 1.5 0 0 0 3 4.5v6.75m18 0-9 6.75-9-6.75" strokeLinecap="round" strokeLinejoin="round"></path>
              </svg>
            </div>
            <h3 className="text-2xl font-bold text-[#193C1F]">Donation</h3>
            <p className="text-[#193C1F] opacity-80">Fund mental health initiatives and support those in need.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1440px] mx-auto py-32 px-12">
        <div className="flex justify-between items-end mb-12">
          <h2 className="text-4xl font-black text-[#193C1F]">Recent Anonymized Reports</h2>
          <a className="text-[#8EA087] font-bold flex items-center gap-2 hover:text-[#193C1F] transition-colors" href="#">
            View Archive
        ...
        <div className="grid grid-cols-3 gap-10">
          <div data-purpose="report-card">
            ...
            <h3 className="text-2xl font-bold text-[#193C1F] mb-2">Report #882</h3>
            <p className="text-[#193C1F] opacity-80 mb-6">Safety concern regarding workplace harassment addressed and resolved via legal mediation.</p>
            <div className="flex gap-2">
              <span className="bg-[#EDE4D8] text-[#8EA087] px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">Resolved</span>
              <span className="bg-[#D0D5CB] text-[#193C1F] px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">Workplace</span>
            </div>
          </div>
          <div data-purpose="report-card">
            <div className="w-full aspect-video bg-[#D0D5CB] rounded-2xl mb-6 flex items-center justify-center text-[#8EA087]">
              <svg className="w-12 h-12" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.042 21.672 13.684 16.6m0 0-2.51 2.225.569-9.47 5.227 7.917-3.286-.672ZM12 2.25V4.5m5.834.166-1.591 1.591M21.75 12h-2.25m-.166 5.834-1.591-1.591M12 21.75V19.5m-5.834-.166 1.591-1.591M2.25 12h2.25m.166-5.834 1.591 1.591" strokeLinecap="round" strokeLinejoin="round"></path>
              </svg>
            </div>
            <h3 className="text-2xl font-bold text-[#193C1F] mb-2">Report #881</h3>
            <p className="text-[#193C1F] opacity-80 mb-6">Community-led intervention provided temporary housing and support for individual in crisis.</p>
            <div className="flex gap-2">
              <span className="bg-[#D0D5CB] text-[#8EA087] px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">Active</span>
              <span className="bg-[#EDE4D8] text-[#193C1F] px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">Housing</span>
            </div>
          </div>
          <div data-purpose="report-card">
            <div className="w-full aspect-video bg-[#D0D5CB] rounded-2xl mb-6 flex items-center justify-center text-[#8EA087]">
            ...
            <h3 className="text-2xl font-bold text-[#193C1F] mb-2">Report #880</h3>
            <p className="text-[#193C1F] opacity-80 mb-6">Emergency mental health consultation provided within 30 minutes of initial report submission.</p>
            <div className="flex gap-2">
              <span className="bg-[#EDE4D8] text-[#8EA087] px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">Emergency</span>
              <span className="bg-[#D0D5CB] text-[#193C1F] px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">Crisis</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1440px] mx-auto grid grid-cols-12 gap-12 mb-20">
          <div className="col-span-4">
            <div className="flex items-center gap-2 mb-8">
              ...
              <span className="text-xl font-bold text-[#193C1F]">CareConnect</span>
            </div>
          ...
          <div className="col-span-4">
            ...
            <ul className="space-y-4 text-[#193C1F] opacity-80">
              <li><a className="hover:text-[#8EA087] transition-colors" href="#">Emergency Help</a></li>
              <li><a className="hover:text-[#8EA087] transition-colors" href="#">FAQ</a></li>
              <li><a className="hover:text-[#8EA087] transition-colors" href="#">Privacy Policy</a></li>
              <li><a className="hover:text-[#8EA087] transition-colors" href="#">Terms of Service</a></li>
            </ul>
          </div>
          <div className="col-span-4">
