...
const MailIcon = () => (
  ...
  >
    <path
      d="M2.5 5.83333L8.83167 10.2658C9.5312 10.7556 10.4688 10.7556 11.1683 10.2658L17.5 5.83333M4.16667 16.6667H15.8333C16.7538 16.6667 17.5 15.9205 17.5 15V5C17.5 4.0795 16.7538 3.33333 15.8333 3.33333H4.16667C3.24619 3.33333 2.5 4.0795 2.5 5V15C2.5 15.9205 3.24619 16.6667 4.16667 16.6667Z"
      stroke="#8EA087"
      strokeWidth="1.66667"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const LockIcon = () => (
  ...
  >
    <path
      d="M15 8.33333V5.83333C15 3.07191 12.7614 0.833333 10 0.833333C7.23858 0.833333 5 3.07191 5 5.83333V8.33333M5 8.33333C3.61929 8.33333 2.5 9.45262 2.5 10.8333V15.8333C2.5 17.214 3.61929 18.3333 5 18.3333H15C16.3807 18.3333 17.5 17.214 17.5 15.8333V10.8333C17.5 9.45262 16.3807 8.33333 15 8.33333H5ZM10 12.5V14.1667M10 14.1667V12.5Z"
      stroke="#8EA087"
      strokeWidth="1.66667"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const EyeIcon = () => (
  ...
  >
    <path
      d="M1 10C1 10 4.18182 3.63636 10 3.63636C15.8182 3.63636 19 10 19 10C19 10 15.8182 16.3636 10 16.3636C4.18182 16.3636 1 10 1 10Z"
      stroke="#8EA087"
      strokeWidth="1.66667"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M10 12.7273C11.5062 12.7273 12.7273 11.5062 12.7273 10C12.7273 8.49383 11.5062 7.27273 10 7.27273C8.49383 7.27273 7.27273 8.49383 7.27273 10C7.27273 11.5062 8.49383 12.7273 10 12.7273Z"
      stroke="#8EA087"
      strokeWidth="1.66667"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const LargeLockIcon = () => (
  ...
  >
    <path
      d="M24 30V34M12 42H36C38.2077 42 40 40.2077 40 38V26C40 23.7923 38.2077 22 36 22H12C9.79234 22 8 23.7923 8 26V38C8 40.2077 9.79234 42 12 42L24 30M44 10V14C44 9.58468 40.4153 6 36 6C31.5847 6 28 9.58468 28 14V22H44V10"
      stroke="#8EA087"
      strokeWidth="4"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const FeatureShieldIcon = () => (
  ...
  >
    <g clipPath="url(#clip0_273_1276)">
      <path
        d="M9 12.0003L11 14.0003L15 10.0003M20.618 5.98434C17.4561 6.15225 14.3567 5.05895 12 2.94434C9.64327 5.05895 6.5439 6.15225 3.382 5.98434C3.12754 6.96945 2.99918 7.98289 3 9.00034C3 14.5913 6.824 19.2903 12 20.6223C17.176 19.2903 21 14.5923 21 9.00034C21 7.95834 20.867 6.94834 20.618 5.98434L9 12.0003"
        stroke="#8EA087"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const FeatureAnonIcon = () => (
  ...
  >
    <path
      d="M3.87086 0.365234L19.3709 14.8652M0.870865 7.86523C10.3709 0.865176 15.3709 0.865294 23.8709 7.86523C15.727 14.4258 10.7271 14.4317 0.870865 7.86523Z"
      stroke="#D1B698"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
      ...
      <nav className="flex gap-[32px]">
        {links.map((link) => (
          <a
            key={link}
            href="#"
            className="hover:underline no-underline text-[#193C1F]"
          >
            {link}
          </a>
        ))}
...
const FeatureCard = ({
  ...
  <div className="flex-1 h-[90px] bg-[#F7F3ED] border border-[#D0D5CB] rounded-[12px] flex flex-col items-center justify-center gap-2 p-4 text-center">
    <Icon />
    <span className="text-[14px] font-bold text-[#193C1F] leading-[20px]">
      {text}
    </span>
  </div>
);
        ...
        <div className="w-[50%] flex flex-col items-center justify-center p-[64px] bg-white animate-fade-up">
          <div className="w-full max-w-[400px]">
            ...
            <form className="space-y-[24px]" onSubmit={handleSubmit}>
              ...
              <div
                className="space-y-[8px] animate-fade-in"
                key={`auth-field-${activeTab}`}
              >
