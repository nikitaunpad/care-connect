    ...
    <div className="min-h-screen flex flex-col font-sans bg-[#F7F3ED] text-[#193C1F]">
      ...
      <header className="w-full bg-[#F7F3ED] border-b border-[#D0D5CB] py-6">
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
          <Link href="/landingPage" className="flex items-center gap-2">
            <svg className="w-8 h-8 text-[#8EA087]" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
          ...
          <nav className="flex items-center gap-8">
            <Link href="/landingPage" className="text-[#193C1F] hover:text-[#8EA087] font-medium">Home</Link>
            <a className="text-[#193C1F] hover:text-[#8EA087] font-medium" href="#">Causes</a>
            <a className="text-[#193C1F] hover:text-[#8EA087] font-medium" href="#">About</a>
            <div className="bg-[#D0D5CB] p-2 rounded-full cursor-pointer">
              <svg className="w-6 h-6 text-[#193C1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main className="flex-grow max-w-6xl mx-auto px-6 py-12 w-full grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-8 flex flex-col gap-8">
          <section>
            <h1 className="text-4xl font-extrabold text-[#193C1F] mb-2">Make a Difference</h1>
            <p className="text-[#8EA087] text-lg">Your support directly impacts lives and keeps our platform running securely.</p>
          </section>
          ...
          <section className="bg-white border border-[#D0D5CB] rounded-xl p-8 shadow-sm">
            <div className="flex items-center gap-2 mb-6 text-[#D1B698]">
              ...
              <h2 className="text-[#193C1F] font-bold text-lg">Select Donation Type</h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="border-2 border-[#193C1F] bg-[#D0D5CB] rounded-xl p-6 cursor-pointer relative">
                ...
                <h3 className="text-[#193C1F] font-bold mb-1">Support a Victim</h3>
                <p className="text-[#8EA087] text-sm leading-tight">Directly fund recovery efforts and medical bills.</p>
              </div>
              ...
              <div className="border border-[#D0D5CB] bg-[#EDE4D8] rounded-xl p-6 cursor-pointer">
                ...
                <h3 className="text-[#193C1F] font-bold mb-1">Support Platform</h3>
                <p className="text-[#8EA087] text-sm leading-tight">Help maintain secure infrastructure and operations.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white border border-[#D0D5CB] rounded-xl p-8 shadow-sm">
            <div className="flex items-center gap-2 mb-6 text-[#D1B698]">
              ...
              <h2 className="text-[#193C1F] font-bold text-lg">Choose Amount</h2>
            </div>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              <button className="py-4 rounded-lg bg-[#EDE4D8] border border-[#D0D5CB] text-[#193C1F] font-bold">$25</button>
              <button className="py-4 rounded-lg bg-[#D0D5CB] border-2 border-[#193C1F] text-[#193C1F] font-bold">$50</button>
              <button className="py-4 rounded-lg bg-[#EDE4D8] border border-[#D0D5CB] text-[#193C1F] font-bold">$100</button>
              <button className="py-4 rounded-lg bg-[#EDE4D8] border border-[#D0D5CB] text-[#193C1F] font-bold">$250</button>
            </div>
            
            <div className="relative">
              <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8EA087]">$</span>
              <input className="w-full pl-8 py-3 rounded-lg border border-[#D0D5CB] bg-white focus:ring-[#8EA087] focus:border-[#8EA087]" placeholder="Enter custom amount" type="text" />
            </div>
          </section>
          ...
          <section className="bg-white border border-[#D0D5CB] rounded-xl p-8 shadow-sm">
            <div className="flex items-center gap-2 mb-6 text-[#D1B698]">
              ...
              <h2 className="text-[#193C1F] font-bold text-lg">Payment Method</h2>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border border-[#D0D5CB] rounded-lg bg-white cursor-pointer">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#193C1F] font-medium">Credit or Debit Card</span>
                </div>
                <svg className="w-6 h-6 text-[#8EA087]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                </svg>
              </div>
        ...
        <aside className="md:col-span-4 flex flex-col gap-6">
          <section className="bg-[#F7F3ED] border border-[#D0D5CB] rounded-xl p-8 shadow-md">
            <h2 className="text-[#193C1F] font-bold text-xl mb-6">Donation Summary</h2>
            <div className="space-y-4 mb-8">
              ...
              <div className="flex justify-between items-end">
                <div className="flex flex-col">
                  ...
                  <span className="text-[#193C1F] font-bold text-lg">Contribution</span>
                </div>
                <span className="text-3xl font-extrabold text-[#D1B698]">$50.00</span>
              </div>
            </div>
          ...
          <section className="bg-[#F7F3ED] border border-[#D0D5CB] rounded-xl p-6 border-l-4 border-l-[#D1B698]">
            <div className="flex gap-3">
              <svg className="w-5 h-5 text-[#D1B698] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
              </svg>
              <div>
                <h4 className="text-[#193C1F] font-bold text-sm mb-2">Why Support Us?</h4>
                <p className="text-[#8EA087] text-xs leading-relaxed">CareConnect ensures that 100% of the funds designated for victims go directly to the cause. Platform donations help us keep our transaction fees at 0% for those in need.</p>
              </div>
            </div>
          </section>
        </aside>
